        ...
        <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-header with-border" align="center">
                    <h3 class="box-title"><strong>Estados</strong></h3>
                    <a href="{{route('estado.create')}}" class="btn btn-small btn-primary pull-right">
                        ...
                        <thead>
                            ...
                            @foreach($estado as $c)
                                <tr>
                                    ...
                                    <td>{{$c->sigla}}</td>
                                    <td align="right">
                                        <a href="{{route('estado.show',$c->id)}}" class="btn btn-small btn-info">
                                            <i class="fa fa-search-plus"></i>
                                            Detalhes
                                        </a>
                                        <a href="{{route('estado.edit',$c->id)}}" class="btn btn-small btn-warning">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        <p>Deseja realmente excluir o estado {{$c->nome}}?</p>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        {{--</form>--}}
                                                        {!! Form::open(array('route' => array('estado.destroy', $c->id), 'method' => 'delete')) !!}
                                                        {!! csrf_field() !!}
                                                        <button class="btn btn-danger" type="submit">Excluir</button>
                                                        <button class="btn btn-default" type="button" data-dismiss="modal">Cancelar</button>
                                                        {!! Form::close() !!}
