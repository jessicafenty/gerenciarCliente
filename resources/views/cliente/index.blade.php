        ...
        <div class="row">
                ...
                <div class="box">
                    ...
                    <div class="box-header with-border" align="center">
                        ...
                        <a href="{{route('cliente.create')}}" class="btn btn-small btn-primary pull-right">
                            ...
                            <thead>
                                ...
                                @foreach($clientes as $c)
                                    <tr>
                                        ...
                                        <td>{{$c->email}}</td>
                                        <td align="right">
                                            <a href="{{route('cliente.show',$c->id)}}" class="btn btn-small btn-info">
                                                <i class="fa fa-search-plus"></i>
                                                Detalhes
                                            </a>
                                            <a href="{{route('cliente.edit',$c->id)}}" class="btn btn-small btn-warning">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {{--</form>--}}
                                                            {!! Form::open(array('route' => array('cliente.destroy', $c->id), 'method' => 'delete')) !!}
                                                            {!! csrf_field() !!}
                                                            <button class="btn btn-danger" type="submit">Excluir</button>
                                                            <button class="btn btn-default" type="button" data-dismiss="modal">Cancelar</button>
                                                            {!! Form::close() !!}
